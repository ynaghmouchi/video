...
import { StickerRound, StickerBanner, MacaronCertifie, MacaronApp, BannerNotoriete, CoBrand } from "./meyebus/stickers/Sticker";

export const RemotionRoot: React.FC = () => {
  return (
    <>
      <Composition id="MacaronCertifie" component={MacaronCertifie} durationInFrames={1} fps={30} width={900} height={900} />
      <Composition id="MacaronApp" component={MacaronApp} durationInFrames={1} fps={30} width={900} height={900} />
